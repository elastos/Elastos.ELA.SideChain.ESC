...
type ChainReader interface {
	...
	// IsToManyEvilSingers return whether to many evil singers.
	IsToManyEvilSingers() bool
}
...
type Engine interface {
	...
	//VerifyRecentAuthor determines the nearest signer based on chain and headers
	VerifyRecentAuthor(chain ChainReader) (error, uint64)
