...
import (
	...
	"github.com/elastos/Elastos.ELA.SideChain.ESC/eth/tracers/internal/tracers"
)
...
// init retrieves the JavaScript transaction tracers included in Elastos.ELA.SideChain.ESC.
func init() {
