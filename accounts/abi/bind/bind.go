...
//
// Detailed usage document and tutorial available on the Elastos.ELA.SideChain.ESC Wiki page:
// https://github.com/elastos/Elastos.ELA.SideChain.ESC/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
