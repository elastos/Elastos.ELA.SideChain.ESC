...
//go:generate abigen --sol contract/FusionRollup.sol --exc contract/AbstractENS.sol:AbstractENS --pkg contract --out contract/fusion.go
...
func NewFusion(transactOpts *bind.TransactOpts, contractAddr common.Address, contractBackend bind.ContractBackend) (*ENS, error) {
...
func DeployFusion(transactOpts *bind.TransactOpts, contractBackend bind.ContractBackend) (common.Address, *ENS, error) {
	...
	ens, err := NewFusion(transactOpts, ensAddr, contractBackend)
	if err != nil {
		return ensAddr, nil, err
	}
...
func FusionNode(name string) common.Hash {
